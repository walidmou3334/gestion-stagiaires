...
export default function RhLivrablesPage() {
    ...
    const loadData = async () => {
        try {
            ...
            const res = await getAllLivrablesRh();
    ...
    const confirmAction = async () => {
        ...
        try {
            ...
            if (actionType === "VALIDER") {
                await validerLivrableRh(selectedLivrable.id, remarque.trim());
                setMessage("Livrable validé avec succès");
            }

            if (actionType === "REJETER") {
                await rejeterLivrableRh(selectedLivrable.id, remarque.trim());
    ...
    return (
        <div className="container-fluid py-4 bg-light min-vh-100">
            <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <div>
                    <h2 className="fw-bold mb-1">Gestion des livrables</h2>

                    <p className="text-muted mb-0">
                        Consultez, téléchargez, validez ou rejetez les livrables des
                        stagiaires.
                    </p>
                </div>
            ...
            <div className="row mb-4">
                    ...
                    <div className="card border-0 shadow-sm rounded-4 h-100">
                        <div className="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 className="fw-bold mb-0">{livrables.length}</h3>
                            </div>
                    ...
                    <div className="card border-0 shadow-sm rounded-4 h-100">
                        <div className="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 className="fw-bold text-warning mb-0">{totalEnAttente}</h3>
                            </div>
                ...
                <div className="col-lg-3 col-md-6 mb-3">
                    <div className="card border-0 shadow-sm rounded-4 h-100">
                        <div className="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <p className="text-muted mb-1">Validés</p>
                                <h3 className="fw-bold text-success mb-0">{totalValides}</h3>
                            </div>
                ...
                <div className="col-lg-3 col-md-6 mb-3">
                    <div className="card border-0 shadow-sm rounded-4 h-100">
                        <div className="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <p className="text-muted mb-1">Rejetés</p>
                                <h3 className="fw-bold text-danger mb-0">{totalRejetes}</h3>
                            </div>
            ...
            <div className="card border-0 shadow-sm rounded-4">
                <div className="card-header bg-white border-0 py-3 px-4">
                    <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <h5 className="fw-bold mb-0">Liste des livrables</h5>
                    ...
                    <div className="table-responsive">
                        <table className="table align-middle">
                            ...
                            {currentLivrables.length === 0 ? (
                                ...
                                currentLivrables.map((l) => (
                                    <tr key={l.id}>
                                        <td>
                                            <span className="fw-semibold">#{l.id}</span>
                                        </td>
                        ...
                        >
                          {l.sujetFinal || "-"}
                                        ...
                                        <td>
                                            <span className="fw-semibold">{l.titre || "-"}</span>
                                        </td>
                        ...
                        <div className="modal-content border-0 rounded-4 shadow">
                            ...
                            <div className="modal-body">
                                <p className="text-muted">
                                    ...
                                    <strong>{selectedLivrable?.titre}</strong>
                                </p>
